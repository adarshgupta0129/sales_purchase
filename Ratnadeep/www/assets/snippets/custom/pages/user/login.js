   ...
   return {
      init: function () {
         l(), $("#m_login_signin_submit").click(function (e) {
            /* e.preventDefault();  commented on 16-11-2018*/
            var a = $(this),
               l = $(this).closest("form");
            l.validate({
               rules: {
               ...
               success: function (e, t, r, s) {
                  setTimeout(function () {
                     a.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), i(l, "danger", "Incorrect emal or password. Please try again.")
                  }, 2e3)
               }
            })) commented on 16-11-2018*/
